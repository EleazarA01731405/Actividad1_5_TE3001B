...
ts = 0.7854;            % Tiempo de muestreo en segundos (s)
...
u = [0, 1.2732, 0, 1.2732, 0, 1.9098, 0, 2.54, 0 ]; % Velocidad lineal de referencia (m/s)
w = [0.7777, 0, -5, 0, 5, 0, -2.3, 0, 0]; % Velocidad angular de referencia (rad/s)
